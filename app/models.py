...
class Solution(db.Model):
    ...
    manufacturer_id = db.Column(
        db.Integer,
        db.ForeignKey("manufacturer.id", name="fk_manufacturer", ondelete="CASCADE"),
        nullable=False,
    )
...
class Component(db.Model):
    ...
    solution_id = db.Column(
        db.Integer,
        db.ForeignKey("solution.id", name="fk_solution", ondelete="CASCADE"),
        nullable=False,
    )
...
class TemplateSection(db.Model):
    ...
    template_id = db.Column(
        db.Integer,
        db.ForeignKey("template.id", name="fk_template", ondelete="CASCADE"),
        nullable=False,
    )
    template = db.relationship("Template", backref="TemplateSection")
    component_id = db.Column(
        db.Integer,
        db.ForeignKey("component.id", name="fk_component", ondelete="CASCADE"),
        nullable=True,
    )
...
class TemplateQuestion(db.Model):
    ...
    section_id = db.Column(
        db.Integer,
        db.ForeignKey("template_section.id", name="fk_section", ondelete="CASCADE"),
        nullable=False,
    )
...
class TemplateListItem(db.Model):
    ...
    template_list_id = db.Column(
        db.Integer,
        db.ForeignKey("template_list.id", name="fk_list", ondelete="CASCADE"),
        nullable=False,
    )
...
class TemplateRisk(db.Model):
    ...
    template_question_id = db.Column(
        db.Integer,
        db.ForeignKey("template_question.id", name="fk_question", ondelete="CASCADE"),
        nullable=False,
    )
...
class Questionnaire(db.Model):
    ...
    customer_id = db.Column(
        db.Integer,
        db.ForeignKey("customer.id", name="fk_customer", ondelete="CASCADE"),
        nullable=False,
    )
    customer = db.relationship("Customer")
    created_at = db.Column(db.DateTime, nullable=True, default=datetime.datetime.utcnow)
    sections = db.relationship(
        "Section", backref="Questionnaire", lazy=True, cascade="all, delete-orphan"
    )
...
class Section(db.Model):
    ...
    questionnaire_id = db.Column(
        db.Integer,
        db.ForeignKey("questionnaire.id", name="fk_questionnaire", ondelete="CASCADE"),
        nullable=False,
    )
    component_id = db.Column(
        db.Integer,
...
class Question(db.Model):
    ...
    section_id = db.Column(
        db.Integer,
        db.ForeignKey("section.id", name="fk_section", ondelete="CASCADE"),
        nullable=False,
    )
...
class DraftQuestionnaireComponent(db.Model):
    ...
    draft_start_questionnaire_id = db.Column(
        db.Integer,
        db.ForeignKey(
            "draft_start_questionnaire.id",
            name="fk_draft_start_questionnaire",
            ondelete="CASCADE",
        ),
        nullable=False,
    )
